...
For Shopifolk, you can reach out to us in Slack on the `#quilt` or `#web-foundation-tech` channels. For external inquiries, we welcome bug reports, enhancements, and feature requests via Github issues.
