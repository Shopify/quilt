...
describe('applyTimeZoneOffset()', () => {
  describe('UTC timezone', () => {
    it('applies the timezone offset', () => {
      ...
      expect(applyTimeZoneOffset(date, 'UTC')).toEqual(expected);
    });
  });
  ...
  describe('not UTC timezone', () => {
    it('applies the timezone offset', () => {
      ...
      expect(applyTimeZoneOffset(date, 'Australia/Perth')).toEqual(expected);
    });
  });
  ...
  describe('Daylight Saving Time', () => {
    it('applies timezone offset when in DST', () => {
      ...
      expect(applyTimeZoneOffset(date, 'Australia/Sydney', 'UTC')).toEqual(
        expected,
      );
    });
