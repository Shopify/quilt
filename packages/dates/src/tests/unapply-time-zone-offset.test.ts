...
describe('unapplyTimeZoneOffset()', () => {
  describe('UTC timezone', () => {
    it('unapplies the timezone offset', () => {
      ...
      expect(unapplyTimeZoneOffset(date, 'UTC')).toStrictEqual(expected);
    });
  });
  ...
  describe('not UTC timezone', () => {
    it('unapplies the timezone offset', () => {
      ...
      expect(unapplyTimeZoneOffset(date, 'Australia/Perth')).toStrictEqual(
        expected,
      );
    });
  });
  ...
  describe('Daylight Saving Time', () => {
    it('unapplies timezone offset when in DST', () => {
      ...
      expect(
        unapplyTimeZoneOffset(date, 'Australia/Sydney', 'UTC'),
