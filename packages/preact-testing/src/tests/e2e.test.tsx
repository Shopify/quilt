import {createContext, ReactNode, Component, ComponentType, Ref} from 'preact';
import * as React from 'preact';
import {useState, useEffect, useContext} from 'preact/hooks';
import {memo, forwardRef, PureComponent, createPortal} from 'preact/compat';
...
describe('@shopify/preact-testing', () => {
  ...
  describe('traversal', () => {
    ...
    it.skip('can traverse through portals', () => {
      function MyComponent() {
