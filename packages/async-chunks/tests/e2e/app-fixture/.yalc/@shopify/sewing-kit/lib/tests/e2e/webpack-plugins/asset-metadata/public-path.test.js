...
const fixture = path_1.resolve(__dirname, 'fixtures', 'public-path');
...
describe('public-path', () => {
    ...
    describe('entrypoints', () => {
        it('prepends public path to assets', () => {
            expect(entrypoints.main.js).toEqual([{ path: 'prepended_path/main.js' }]);
            expect(entrypoints.main.css).toEqual([{ path: 'prepended_path/main.css' }]);
        });
    });
});