...
Translations are serialized into files according to [the React I18n schema](https://github.com/Shopify/quilt/blob/master/packages/react-i18n/docs/react_i18n_schema.md).
