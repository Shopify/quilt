...
import {validateFixtureAgainstAST, validateFixtureAgainstSchema} from '../src/validate';
...
describe('validate', () => {
  describe('validateFixtureAgainstAST()', () => {
    ...
    it('validates enums', () => {
      ...
      expect(validateAgainstAST({generation: 'SEVENTH'}, ast)).toMatchSnapshot();
    ...
    describe('lists', () => {
      it('validates the types of lists', () => {
        ...
        expect(validateAgainstAST({}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({favoriteNumbers: null}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({favoriteNumbers: []}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({favoriteNumbers: {}}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({favoriteNumbers: [1, 2.5, null, true, 5]}, ast)).toMatchSnapshot();
      });
      ...
      it('validates nested arrays', () => {
        ...
        expect(validateAgainstAST({sets: [[1, 2, null], [true, {}, 3]]}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({sets: [null, [1, 2], true]}, ast)).toMatchSnapshot();
      });
      ...
      it('validates objects nested in arrays', () => {
        ...
        expect(validateAgainstAST({people: [{}]}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({people: [{name: true}]}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({people: [{name: 'Chris'}]}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({people: [{name: 'Chris', age: 42}]}, ast)).toMatchSnapshot();
      });
    });
    ...
    describe('objects', () => {
      it('validates that the value is actually an object', () => {
        ...
        expect(validateAgainstAST({person: {name: true}}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({person: {name: 'Chris'}}, ast)).toMatchSnapshot();
      });
      ...
      it('creates errors for keys not present in the query', () => {
        ...
        expect(validateAgainstAST({person: {name: 'Chris', age: 42}}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({person: {name: 'Chris', foo: true}}, ast)).toMatchSnapshot();
      });
      ...
      it('validates aliases', () => {
        ...
        expect(validateAgainstAST({person: null}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({person: {}}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({person: {nom: true}}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({person: {nom: 'Chris'}}, ast)).toMatchSnapshot();
        ...
        expect(validateAgainstAST({chris: {nom: 'Chris'}}, ast)).toMatchSnapshot();
      });
    });
    ...
    describe('fragments', () => {
      ...
      it('treats fields on interface type spreads to be nullable', () => {
        ...
        expect(validateAgainstAST({animals: [{}]}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({animals: [{name: 'Winston'}]}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({animals: [{name: 'Winston', barks: 40}]}, ast)).toMatchSnapshot();
        expect(validateAgainstAST({animals: [{name: 'Winston', barks: true}]}, ast)).toMatchSnapshot();
      });
    });
    ...
    it('works with multiple top-level items', () => {
      ...
      expect(validateAgainstAST({}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({name: null}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({name: null, age: 42.5}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({name: 'Chris'}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({name: 'Chris', age: null}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({name: 'Chris', age: 42}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({name: 'Chris', age: 42.5}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({name: 'Chris', age: '42'}, ast)).toMatchSnapshot();
    });
    ...
    it('validates mutations', () => {
      ...
      expect(validateAgainstAST({haveBirthday: {hadFunBirthday: null}}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({haveBirthday: {hadFunBirthday: 'true'}}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({haveBirthday: {hadFunBirthday: true}}, ast)).toMatchSnapshot();
      expect(validateAgainstAST({haveBirthday: {hadFunBirthday: false}}, ast)).toMatchSnapshot();
    });
  });
